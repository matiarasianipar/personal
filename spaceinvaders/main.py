...
def main():
    ...
    # Store enemy locations and initialize movement
    enemies = []
    wave_length = 5
    enemy_vel = 1
    ...
    while run:
        ...
        for enemy in enemies[:]:
            ...
            # Lose health for getting hit
            if collide(enemy, player):
                player.health -= 10
                enemies.remove(enemy)
                
            # Lose lives for undefeated enemies reaching the bottom
